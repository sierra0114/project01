          ...
          <el-form-item label=" 头   像：">
            ...
            <div>
              <el-avatar
                ...
                @click="changeimg"
              ></el-avatar>
              <el-avatar icon="el-icon-basketball"></el-avatar>
              <el-avatar icon="el-icon-cold-drink"></el-avatar>
              <el-avatar icon="el-icon-grape"></el-avatar>
              <el-avatar icon="el-icon-apple"></el-avatar>
              <el-avatar icon="el-icon-lollipop"></el-avatar>
              <el-avatar icon="el-icon-coffee"></el-avatar>
            </div>
          </el-form-item>
...
export default {
  ...
  data() {
    ...
    return {
      ...
      iconlist: ["el-icon-basketball","el-icon-cold-drink","el-icon-grape","el-icon-apple","el-icon-lollipop",],
    };
  },
  methods: {
    handleChange(val) {

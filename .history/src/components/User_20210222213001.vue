    ...
    <el-collapse v-model="activeNames" @change="handleChange">
      <el-collapse-item name="1">
        ...
        <el-form ref="form" :model="form" label-width="80px" size="small">
          ...
          <el-form-item label=" 昵称：" class="input"> <el-input></el-input></el-form-item>
          <el-form-item label=" 邮箱：" class="input" aria-placeholder="请输入邮箱">
            <el-input
              type="email"
      ...
      <el-collapse-item name="3">
        ...
        <el-form
          ...
          class="demo-ruleForm"
        >
          <el-form-item label="当前密码" prop="oldpass" class="input">
            <el-input
              type="password"
          ...
          <el-form-item label="密码" prop="pass" class="input">
            <el-input
              type="password"
              v-model="ruleForm.pass"
              autocomplete="off"

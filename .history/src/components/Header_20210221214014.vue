          ...
          <el-col :xs="0" :sm="3" :md="3" :lg="3" hidden-xs-only>
            ...
            <el-link>
              ...
              @command="handleCommand">
                ...
                <el-dropdown-menu >
                  <el-dropdown-item command="approaching">进行事项</el-dropdown-item>
                  <el-dropdown-item command="expired">过期事项</el-dropdown-item>
                  <el-dropdown-item command="system" divided>系统消息</el-dropdown-item>
                </el-dropdown-menu>
              </el-dropdown>
            </el-link>
            <!-- ↑↑↑↑↑↑↑↑↑↑ -->
...
export default {
  ...
  methods: {
    ...
    querySearchAsync (queryString, callBack) {
      ...
      var results = queryString ? events.filter(this.createInputFilter(queryString)) : events
  ...
  created () {
    ...
    request.onsuccess = (event) => {
      ...
      transaction1 = db.transaction('info', 'readwrite') // 获取全部info
      ...
      transaction2 = db.transaction('user', 'readwrite')

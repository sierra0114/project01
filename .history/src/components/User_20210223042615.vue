      ...
      <el-collapse-item name="1">
        ...
        >
          <el-form-item label=" 头   像：">
            <div>
              <el-avatar :icon="icon"></el-avatar>
            </div>
            <div>
              <el-avatar icon="el-icon-basketball" class="orange"></el-avatar>
              <el-avatar icon="el-icon-cold-drink" class="yellow"></el-avatar>
              <el-avatar icon="el-icon-grape" class="purple"></el-avatar>
              <el-avatar icon="el-icon-apple" class="red"></el-avatar>
              <el-avatar icon="el-icon-lollipop" class="blue"></el-avatar>
              <el-avatar icon="el-icon-coffee" class="brown"></el-avatar>
            </div>
          </el-form-item>
